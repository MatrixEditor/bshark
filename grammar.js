/**
 * @file grammar for AIDL tree-sitter (modified from Java grammar)
...
module.exports = grammar({
  ...
  rules: {
    ...
    parcelable_declaration: $ => seq(
      'parcelable',
      field('name', $._name),
      optional(seq('cpp_header', field("cpp_header", $.string_literal))),
    ...
    binder_method_declaration: $ => seq(
      optional($.modifiers),
      $._binder_method_header,
      choice(seq('=', field('tc', $._literal), ';'), ';'),
    ),
